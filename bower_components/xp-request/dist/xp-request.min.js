...
!function(e){"use strict";var t=require("http"),n=require("https"),i=e.XP||require("expandjs"),r=e.XPEmitter||require("xp-emitter");module.exports=new i.Class("XPRequest",{"extends":r,options:{dataType:"text",headers:null,keepAlive:0,method:"GET",path:"",port:null,url:""},initialize:{promise:!0,value:function(t,n){i.assertArgument(i.isObject(t)||i.isString(t,!0),1,"Object or string");var s=this,a=e.location||{};r.call(s),s.chunks=[],s.options=i.isString(t)?{}:t,s.dataType=s.options.dataType,s.headers=s.options.headers||{},s.keepAlive=s.options.keepAlive,s.method=s.options.method,s.url=s.options.url,s.path=s.options.path,s.port=s.options.port,s.secure="https:"===(s.parsed.protocol||a.protocol),s.resolver=n,s.state="idle",s.adapt(),s.adaptee.on("error",s.handleError.bind(s)),s.adaptee.on("response",s.handleResponse.bind(s))}},abort:function(){var e=this;return e.timeAbort?e:(e.adaptee.abort(),e.state="aborted",e.timeAbort=Date.now(),e)},submit:function(e){i.assertArgument(i.isVoid(e)||i.isObject(e)||i.isString(e,!0),1,"Buffer, Object or string");var t=this;return t.timeSubmit?t:("GET"===t.method||i.isString(e)||Buffer.isBuffer(e)||(e=JSON.stringify(e)),t.adaptee.end("GET"!==t.method?e:void 0),t.state="pending",t.timeSubmit=Date.now(),t)},adapt:{enumerable:!1,value:function(){var i=this,r=e.location||{},s=i.secure?443:80,a=i.secure?n:t;return i.adaptee=a.request({auth:i.parsed.auth,headers:i.headers,hostname:i.parsed.hostname||r.hostname,keepAlive:i.keepAlive>0,keepAliveMsecs:Math.max(i.keepAlive,0),method:i.method,path:i.path||i.parsed.path+(i.parsed.hash||""),port:i.port||i.parsed.port||i.parsed.hostname&&s||r.port,withCredentials:!1}),i}},parse:{enumerable:!0,value:function(e){var t=this;return"json"===t.dataType?JSON.parse(e):e}},adaptee:{enumerable:!1,set:function(e){return this.request||e},validate:function(e){return i.isObject(e)}},chunks:{set:function(e){return this.chunks||e},validate:function(e){return i.isArray(e)}},data:{validate:function(e){return i.isString(e)||Buffer.isBuffer(e)}},dataType:{set:function(e){return this.dataType||e},validate:function(e){return i.includes(this.dataTypes,e)}},dataTypes:{frozen:!0,writable:!1,value:["json","text"]},headers:{set:function(e){return this.headers||e},validate:function(e){return i.isObject(e)}},keepAlive:{set:function(e){return this.keepAlive>=0?this.keepAlive:e},validate:function(e){return i.isInt(e,!0)}},method:{set:function(e){return this.method||i.upperCase(e)},validate:function(e){return i.isString(e,!0)}},parsed:{set:function(e){return this.parsed||e},validate:function(e){return i.isObject(e)}},path:{set:function(e){return i.isDefined(this.path)?this.path:!this.url&&e||""},validate:function(e){return i.isString(e)}},port:{set:function(e){return i.isDefined(this.port)?this.port:!this.url&&e||null},validate:function(e){return i.isVoid(e)||i.isFinite(e,!0)}},response:{set:function(e){return this.response||e},validate:function(e){return i.isObject(e)}},secure:{set:function(e){return i.isDefined(this.secure)?this.secure:!!e}},state:{then:function(e){this.emit("state",e,this)},validate:function(e){return i.includes(this.states,e)}},states:{frozen:!0,writable:!1,value:["aborted","failed","idle","pending","received","receiving"]},timeAbort:{set:function(e){return this.timeAbort||e},validate:function(e){return i.isFinite(e,!0)}},timeData:{set:function(e){return this.timeData||e},validate:function(e){return i.isFinite(e,!0)}},timeResponse:{set:function(e){return this.timeResponse||e},validate:function(e){return i.isFinite(e,!0)}},timeSubmit:{set:function(e){return this.timeSubmit||e},validate:function(e){return i.isFinite(e,!0)}},url:{set:function(e){return i.isDefined(this.url)?this.url:e||""},then:function(e){this.parsed=i.parseURL(e)||{}},validate:function(e){return i.isString(e)}},handleData:function(e){var t=this;t.chunks.push(e),t.emit("chunk",e,t)},handleEnd:function(){var e=this;try{e.data=e.parse(Buffer.isBuffer(e.chunks[0])?Buffer.concat(e.chunks):e.chunks.join("")),e.state="received",e.timeData=Date.now()}catch(t){return e.handleError(t.message)}e.resolver(null,e.data),e.emit("data",e.data,e)},handleError:function(e){var t=this;t.state="failed",t.timeResponse=Date.now(),t.timeData=t.timeResponse,t.resolver(e),t.emit("response",null,t),t.emit("error",e,t)},handleResponse:function(e){var t=this;t.response=e,t.state="receiving",t.timeResponse=Date.now(),e.on("data",t.handleData.bind(t)),e.on("end",t.handleEnd.bind(t)),t.emit("response",e,t)}})}("undefined"!=typeof window?window:global);
